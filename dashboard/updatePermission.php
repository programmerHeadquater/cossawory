...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (user_canDeleteUser((int) $_SESSION['user_id'])['status']) {
        ...
        $sucess = user_updatePermission($id, $can_write_review, $can_delete_review, $can_delete_submission, $can_add_user, $can_delete_user);

        
        echo json_encode(['success' => true, 'message' => 'All feilds are updated sucessfully.']);
        exit;
    } else {
